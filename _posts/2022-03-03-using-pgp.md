# Using PGP
Notes on using PGP (incomplete). See also my [Book of Verifications](https://mattborja.dev/book-of-verifications.html).

## Resources
- [OpenPGP Best Practices](https://help.riseup.net/en/security/message-security/openpgp/best-practices)
- [SecureApt (Debian)](https://wiki.debian.org/SecureApt#How_to_find_and_add_a_key)

### Securing Debian Manual
Source: [Internet Archive](https://web.archive.org/web/20200328044932/https://www.debian.org/doc/manuals/securing-debian-howto/ch7)
```
